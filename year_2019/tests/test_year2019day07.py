...
from year_2019.year_2019_day_07 import (
    solve_part1,
    solve_part2,
)
...
def test_solve_part1_with_right_combinations(
    inputs: str, combination: str, expected: int
) -> None:
    data = list(map(int, inputs.split(',')))
    comb = tuple(map(int, combination.split(',')))
    assert solve_part1(data, comb) == expected
...
def test_solve_part1(inputs: str, expected: int) -> None:
    data = list(map(int, inputs.split(',')))
...
def test_solve_part2_with_right_combinations(
    inputs: str, combination: str, expected: int
) -> None:
    data = list(map(int, inputs.split(',')))
    comb = tuple(map(int, combination.split(',')))
    assert solve_part2(data, comb) == expected
