...
from year_2019.year_2019_day_14 import (
    read_data,
    solve_part1,
    solve_part2,
)

TEST_DATA1 = """10 ORE => 10 A
1 ORE => 1 B
7 A, 1 B => 1 C
7 A, 1 C => 1 D
7 A, 1 D => 1 E
...
"""
TEST_DATA4 = """2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG
